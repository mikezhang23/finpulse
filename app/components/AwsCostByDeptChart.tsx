...
interface AwsCostByDeptChartProps {
  data: DeptDataPoint[];
}

export default function AwsCostByDeptChart({ data }: AwsCostByDeptChartProps) {
  if (!data || data.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 className="text-lg font-semibold mb-4">AWS Costs by Department</h3>
