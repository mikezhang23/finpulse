...
interface ExpenseByDayChartProps {
  data: ChartDataPoint[];
}

export default function ExpenseByDayChart({ data }: ExpenseByDayChartProps) {
  if (!data || data.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 className="text-lg font-semibold mb-4">Expenses by Day</h3>
